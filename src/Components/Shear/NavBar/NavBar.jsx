...
const NavBar = () => {
  ...
  return (
    <div>
      <div className="dark:bg-gray-900 relative shadow-md">
        <div className="px-4 py-3 mx-auto sm:max-w-xl md:max-w-full lg:max-w-[1400px] md:px-24 lg:px-8">
          <div className="relative flex items-center justify-between">
            <Link
              to="/"
              className="inline-flex items-center dark:text-gray-400 text-gray-500"
            >
              <svg
              ...
              <span className="ml-2 text-xl font-bold tracking-wide text-gray-500 uppercase dark:text-gray-400">
                Company
              </span>
            </Link>
            ...
            <div className="lg:hidden">
              ...
              {isMenuOpen && (
                <div className="absolute top-0 left-0 w-full z-[999999] shadow-lg">
                  <div className="p-5 bg-white light:border rounded shadow-sm dark:bg-gray-800">
                    ...
                    <nav>
                      <ul className="space-y-4 dark:text-black">
                        {navBarMenu}
                      </ul>
                    </nav>
                  </div>
        ...
        {sideMenu && (
          ...
          >
            <button
              aria-label="Close Menu"
              title="Close Menu"
              className="p-2 -mt-2 -mr-2 transition duration-200 rounded hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline lg:hidden"
